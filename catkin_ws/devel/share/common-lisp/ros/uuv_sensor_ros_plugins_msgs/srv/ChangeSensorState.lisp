...
(cl:in-package uuv_sensor_ros_plugins_msgs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ChangeSensorState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ChangeSensorState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uuv_sensor_ros_plugins_msgs-srv:<ChangeSensorState-request> is deprecated: use uuv_sensor_ros_plugins_msgs-srv:ChangeSensorState-request instead.")))

(cl:ensure-generic-function 'on-val :lambda-list '(m))
(cl:defmethod on-val ((m <ChangeSensorState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_sensor_ros_plugins_msgs-srv:on-val is deprecated.  Use uuv_sensor_ros_plugins_msgs-srv:on instead.")
  (on m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ChangeSensorState-request>)))
  ...
  "uuv_sensor_ros_plugins_msgs/ChangeSensorStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ChangeSensorState-request)))
  "Returns string type for a service object of type 'ChangeSensorState-request"
  "uuv_sensor_ros_plugins_msgs/ChangeSensorStateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <ChangeSensorState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ChangeSensorState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uuv_sensor_ros_plugins_msgs-srv:<ChangeSensorState-response> is deprecated: use uuv_sensor_ros_plugins_msgs-srv:ChangeSensorState-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ChangeSensorState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_sensor_ros_plugins_msgs-srv:success-val is deprecated.  Use uuv_sensor_ros_plugins_msgs-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <ChangeSensorState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_sensor_ros_plugins_msgs-srv:message-val is deprecated.  Use uuv_sensor_ros_plugins_msgs-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ChangeSensorState-response>)))
  ...
  "uuv_sensor_ros_plugins_msgs/ChangeSensorStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ChangeSensorState-response)))
  "Returns string type for a service object of type 'ChangeSensorState-response"
  "uuv_sensor_ros_plugins_msgs/ChangeSensorStateResponse")
