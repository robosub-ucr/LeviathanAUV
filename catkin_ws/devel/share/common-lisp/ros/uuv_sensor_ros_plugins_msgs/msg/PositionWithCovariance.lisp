...
(cl:defmethod cl:initialize-instance :after ((m <PositionWithCovariance>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PositionWithCovariance)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name uuv_sensor_ros_plugins_msgs-msg:<PositionWithCovariance> is deprecated: use uuv_sensor_ros_plugins_msgs-msg:PositionWithCovariance instead.")))
...
(cl:defmethod covariance-val ((m <PositionWithCovariance>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uuv_sensor_ros_plugins_msgs-msg:covariance-val is deprecated.  Use uuv_sensor_ros_plugins_msgs-msg:covariance instead.")
  (covariance m))
